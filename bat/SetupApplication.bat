...
:: Android packaging
set AND_CERT_NAME="Words-n-Colors"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\WordsnColors.p12
...
set IOS_PROVISION=cert\WordsnColors.mobileprovision
...
set APP_ID=air.com.stichoza.android.wnc.WordsnColors

:: Output packages
set DIST_PATH=dist
set DIST_NAME=WordsnColors
